...
pkgdatadir = $(datadir)/eazy
pkgincludedir = $(includedir)/eazy
pkglibdir = $(libdir)/eazy
pkglibexecdir = $(libexecdir)/eazy
...
CONFIG_HEADER = $(top_builddir)/src/config/eazy-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/eazy-config.h.in \
...
ACLOCAL = ${SHELL} /home/tex/workspaces/EZY/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/tex/workspaces/EZY/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/tex/workspaces/EZY/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/tex/workspaces/EZY/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = eazy-cli
BITCOIN_DAEMON_NAME = eazyd
BITCOIN_GUI_NAME = eazy-qt
BITCOIN_TX_NAME = eazy-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/tex/workspaces/EZY/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = eazy
PACKAGE_BUGREPORT = www.eazy.org
PACKAGE_NAME = Eazy Core
PACKAGE_STRING = Eazy Core 3.1.99
PACKAGE_TARNAME = eazy
PACKAGE_URL = 
PACKAGE_VERSION = 3.1.99
PATH_SEPARATOR = :
PIC_FLAGS = -fPIC
PIE_FLAGS = -fPIC
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/tex/workspaces/EZY
abs_srcdir = /home/tex/workspaces/EZY
abs_top_builddir = /home/tex/workspaces/EZY
abs_top_srcdir = /home/tex/workspaces/EZY
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/tex/workspaces/EZY/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_eazy_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_eazy_coverage.info test_eazy.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/EAZY-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/eazy-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/eazy-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/eazy-config.h
$(top_srcdir)/src/config/eazy-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/eazy-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/EAZY-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/EAZY-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/EAZY-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_eazy.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_eazy -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_eazy_filtered.info: test_eazy.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_eazy_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_eazy_coverage.info: baseline_filtered_combined.info test_eazy_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_eazy_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_eazy_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_eazy_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_eazy.coverage/.dirstamp:  test_eazy_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_eazy.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_eazy.coverage/ total.coverage/ $(OSX_APP)
