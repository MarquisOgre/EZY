Contributing to EAZY Core
============================

The EAZY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EAZY Core project, and is not to be
confused with overall EAZY Network Protocol consensus changes.

Whether a pull request is merged into EAZY Core rests with the project merge
...
Patches that change EAZY consensus rules are considerably more involved than
...
Where a patch set proposes to change the EAZY consensus, it must have been
...
The project leader is the release manager for each EAZY Core release.
