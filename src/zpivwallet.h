...
#ifndef EAZY_ZEZYWALLET_H
#define EAZY_ZEZYWALLET_H
...
public:
    CzEZYWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZEZY(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZEZY(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //EAZY_ZEZYWALLET_H
