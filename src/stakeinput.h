...
#ifndef EAZY_STAKEINPUT_H
#define EAZY_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZEZY() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zEZYStake can take two forms
...
public:
    ...
    bool IsZEZY() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZEZY() override { return false; }
};


#endif //EAZY_STAKEINPUT_H
