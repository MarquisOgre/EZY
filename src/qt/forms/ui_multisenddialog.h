...
public:
    ...
    void retranslateUi(QDialog *MultiSendDialog)
    {
        ...
        label_2->setText(QApplication::translate("MultiSendDialog", "MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other EAZY addresses after it matures.\n"
...
"MultiSend will not be activated unless you have clicked Activate", Q_NULLPTR));
        ...
        label_3->setText(QApplication::translate("MultiSendDialog", "Label:", Q_NULLPTR));
        labelAddressLabelEdit->setPlaceholderText(QApplication::translate("MultiSendDialog", "Enter a label for this address to add it to your address book", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
