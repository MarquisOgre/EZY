...
public:
    ...
    void setupUi(QDialog *ZPivControlDialog)
    {
        ...
        ZPivControlDialog->resize(681, 450);
        ZPivControlDialog->setMinimumSize(QSize(681, 450));
        ...
        __qtreewidgetitem->setText(3, QStringLiteral("zEZY Version"));
        __qtreewidgetitem->setText(2, QStringLiteral("zEZY ID"));
    ...
    {
        ZPivControlDialog->setWindowTitle(QApplication::translate("ZPivControlDialog", "Select zEZY to Spend", Q_NULLPTR));
        ...
        labelZPiv->setText(QApplication::translate("ZPivControlDialog", "zEZY", Q_NULLPTR));
        ...
        ___qtreewidgetitem->setText(5, QApplication::translate("ZPivControlDialog", "Is Spendable", Q_NULLPTR));
    } // retranslateUi
