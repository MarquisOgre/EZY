...
QT_MOC_LITERAL(7, 108, 26), // "anonymizeEazyAmountChanged"
QT_MOC_LITERAL(8, 135, 26), // "coinControlFeaturesChanged"
QT_MOC_LITERAL(9, 162, 23) // "hideZeroBalancesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "zeromintEnableChanged\0zeromintPercentageChanged\0"
    "preferredDenomChanged\0anonymizeEazyAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->anonymizeEazyAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::anonymizeEazyAmountChanged)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void OptionsModel::anonymizeEazyAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
