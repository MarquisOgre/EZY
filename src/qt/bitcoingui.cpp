                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EAZY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EAZY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eazy: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEZY"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EAZY Core"), this);
    aboutAction->setStatusTip(tr("Show information about EAZY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EAZY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EAZY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EAZY addresses"));
    ...
    openAction->setStatusTip(tr("Open a EAZY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EAZY Core help message to get a list with possible EAZY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EAZY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EAZY network", "", count));
}
...
{
    QString strTitle = tr("EAZY Core"); // default title
