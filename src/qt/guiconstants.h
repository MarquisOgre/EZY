...
/* Eazy GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EAZY"
#define QAPP_ORG_DOMAIN "eazy.org"
#define QAPP_APP_NAME_DEFAULT "EAZY-Qt"
#define QAPP_APP_NAME_TESTNET "EAZY-Qt-testnet"
