/* src/config/eazy-config.h.  Generated from eazy-config.h.in by configure.  */
/* src/config/eazy-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.eazy.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eazy Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eazy Core 3.1.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eazy"
