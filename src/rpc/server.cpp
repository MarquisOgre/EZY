...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EAZY features */
        {"eazy", "masternode", &masternode, true, true, false},
        {"eazy", "listmasternodes", &listmasternodes, true, true, false},
        {"eazy", "getmasternodecount", &getmasternodecount, true, true, false},
        {"eazy", "masternodeconnect", &masternodeconnect, true, true, false},
        {"eazy", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"eazy", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"eazy", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"eazy", "masternodecurrent", &masternodecurrent, true, true, false},
        {"eazy", "masternodedebug", &masternodedebug, true, true, false},
        {"eazy", "startmasternode", &startmasternode, true, true, false},
        {"eazy", "createmasternodekey", &createmasternodekey, true, true, false},
        {"eazy", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"eazy", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"eazy", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"eazy", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"eazy", "getmasternodescores", &getmasternodescores, true, true, false},
        {"eazy", "mnbudget", &mnbudget, true, true, false},
        {"eazy", "preparebudget", &preparebudget, true, true, false},
        {"eazy", "submitbudget", &submitbudget, true, true, false},
        {"eazy", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"eazy", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"eazy", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"eazy", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"eazy", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"eazy", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"eazy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"eazy", "checkbudgets", &checkbudgets, true, true, false},
        {"eazy", "mnsync", &mnsync, true, true, false},
        {"eazy", "spork", &spork, true, true, false},
        {"eazy", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> eazy-cli " + methodname + " " + args + "\n";
}
